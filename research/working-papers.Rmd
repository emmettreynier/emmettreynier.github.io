...
#### **[Glyphosate exposure and GM seed rollout unequally reduced perinatal health](papers/rubin-saulnier-gly.pdf)** with [Ed Rubin](http://edrub.in/)  
...
```{r fig2, echo = FALSE, fig.show="hold", out.width="33%", fig.cap = "**Left**: Increase in GLY 1995 to 2012. **Middle**: Effect of GM suitability on GLY. **Right**: Effect of GM suitability on birthweight."}

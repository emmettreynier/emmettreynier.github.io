...
author: "US EPA National Center for Environmental Economics"
...
here::i_am('saulnier-ncee/saulnier-ncee.rmd')
...
knitr::include_graphics(
  path = "figs-climate/climate/prism-grid-cold-days-1990-2019.jpeg"
)
...
There are now more hot days than there were in the 80's .sup[*]
...
#ks_test = ks.test(
#  prism_cbsa_daily_dt[cbsa_fip == '27260' & period == '1990' & variable == 'tmean']$value,
#  prism_cbsa_daily_dt[cbsa_fip == '27260' & period == '2019' & variable == 'tmean']$value,
#  alternative = 'greater'
#)
#ks_test$p.value
...
.footnote[*K-S test p-value < 1e-6]
...
```{r, out.width = "100%"}
knitr::include_graphics("figs-climate/climate/fsf-mean-score-fire.jpeg")
```
]
...
```{r, out.width = "100%"}
knitr::include_graphics("figs-climate/climate/fsf-mean-score-flood.jpeg")
```
]
...
```{r, out.width='65%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/delta-decomp/mc-hist-2019.jpeg")
```
...
```{r, results = 'asis'}
  levels_mod_cal = qread('data/levels_mod_cal_cntrl.qs')
  etable(
...
```{r results='asis'}
  ...
  pack_rows("EPA Headquarters", 6,6) |>
...
knitr::include_graphics("figs-climate/model/general-eqm/cv-perc-ind-1990-2019.jpeg")
```

- Welfare loss for median black HH **22% larger** than median white HH  
- This amounts to damages of 2.9% vs 2.4% of income
...
knitr::include_graphics("figs-climate/model/general-eqm/inc-q10-cv-perc-5y.jpeg")
```
...
```{r energy-eos, results = 'asis'}
  base_path = 'data/comfort-delta-decomp/'
  spline_choice = '/spline-deg-7/'
  # Reading models w/different fixed effects
  dem_cbsa_mods = qread(paste0(base_path, 'dem_group_cbsa', spline_choice,'mod.qs'))
  cbsa_mods = qread(paste0(base_path,'cbsa', spline_choice, 'mod.qs'))
  year_mods = qread(paste0(base_path,'year', spline_choice, 'mod.qs'))
  dem_mods = qread(paste0(base_path,'dem_group', spline_choice, 'mod.qs'))
  dem_year_mods = qread(paste0(base_path,'dem_group_year', spline_choice, 'mod.qs'))
...
<center>.hi-yellow[for electricity benefit]</center>
```{r, out.width='65%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/comfort/kappas-elec-het-bootstrap.jpeg")
```
...
<center>.hi-green[for gas benefit]</center>
```{r, out.width='65%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/comfort/kappas-gas-het-bootstrap.jpeg")
```
...
```{r, out.width='90%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/comfort/marginal-effect-comfort-price-dem-bootstrap.jpeg")
```
...
```{r, out.width='70%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/delta-decomp/climate-amenities-all-temp-vars.jpeg")
```
...
```{r, out.width='90%', fig.align='center'}
  knitr::include_graphics("figs-climate/model/delta-decomp/climate-amenities-spline-7-full-bootstrap.jpeg")
```
...
knitr::include_graphics('figs-climate/climate-change-vs-1990/elasticities.jpeg')
```
...
```{r out.width='80%', fig.align='center'}
knitr::include_graphics("figs-climate/model/general-eqm/state_diff_5y_energy_price_sim_1990_2019.jpeg")
```
...
.pull-left[
```{r out.width='100%', fig.align='center'}
knitr::include_graphics("figs-climate/model/general-eqm/wage-distr-1990-2019.jpeg")
```
]
...
.pull-right[
```{r out.width='100%', fig.align='center'}
knitr::include_graphics("figs-climate/model/general-eqm/wage-ratio-1990-2019.jpeg")
```
]
...
pagedown::chrome_print(
  "saulnier-ncee/saulnier-ncee.html",
  output = "presentations/saulnier-ncee/saulnier-ncee.pdf"
)
```